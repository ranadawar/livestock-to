...
const RequestAppointmentOwner = ({ navigation, route }) => {
    ...
    <AppScreen>
      <View style={{ flex: 1, marginHorizontal: 20 }}>
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.title}>Add Details For Goods</Text>
...
export default RequestAppointmentOwner;
