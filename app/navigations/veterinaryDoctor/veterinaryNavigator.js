...
import VeterinaryStackNavigator from "./veterinaryStackNavigator";
import Insights from "../../screens/app/customer/Insights";

const Tab = createBottomTabNavigator();

const VeterinaryNavigator = () => {
  return (
    <Tab.Navigator screenOptions={{ headerShown: false }}>
      <Tab.Screen name="home" 
      component={VeterinaryStackNavigator} 
      options={{
...
export default VeterinaryNavigator;
